...
void Cheats::New_Menu()
{
	...
	ImGui::Begin("Menu", nullptr, ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoBackground);
	{
		...
		{
			ImGui::GetForegroundDrawList()->AddText(OSImGui::tab_text3, 20 * dpi_scale, ImVec2(20 * dpi_scale + p.x, 12 * dpi_scale + p.y), ImColor(255, 255, 255, 255), "External");
			...
			if (ImGui::Tab("H", "Aimbot", "Legitbot,RCS", 0 == tabs, ImVec2(150 * dpi_scale, 42 * dpi_scale))) tabs = 0;
			if (ImGui::Tab("F", "Visuals", "Player", 1 == tabs, ImVec2(150 * dpi_scale, 42 * dpi_scale))) tabs = 1;
			if (ImGui::Tab("E", "Misc", "Other settings", 2 == tabs, ImVec2(150 * dpi_scale, 42 * dpi_scale))) tabs = 2;
